          ...
          <div className="flex flex-col sm:flex-row gap-4 flex-1">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full bg-gray-700 border border-gray-600 rounded-lg pl-10 pr-4 py-2 text-white placeholder-gray-400 focus:border-yellow-400 focus:outline-none"
              />
            </div>
            ...
            <div className="flex gap-2">
              <select
                ...
                className="bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-white focus:border-yellow-400 focus:outline-none"
              >
